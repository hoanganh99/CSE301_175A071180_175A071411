	...
	<div class="footer">
		...
		<div class="livehelperchat" style='color= red;    text-decoration: none;'>
				<div class="live" style=' text-decoration: none;'>
					<button  style='  background-color: #0f4f8f; border-top-right-radius: 5px;  border-top-left-radius: 5px; margin-right: 10px; display: flex;  position: fixed; bottom: 0; left: 0;  z-index: 9;'>
					<a href="//hoangthingocanh.com/index.php/" style=' text-decoration: none;'> Live Helper Chat </a>
					</button>
				</div>
		</div>
...
po.src = '//hoangthingocanh.com/index.php/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(top)/350/(units)/pixels/(leaveamessage)/true?r='+referrer+'&l='+location;
